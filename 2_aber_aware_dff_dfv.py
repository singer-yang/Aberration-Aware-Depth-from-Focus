...
Use DFVNet for training and evaluation.
"""
import os
import yaml
import wandb
...
from dff import *
from DFV_models import DFVNet

def config():
    with open('configs/aber_aware_dff.yml') as f:
...
def train(args):
    ...
    net = DFVNet(clean=False, level=2, use_diff=True)
